        ...
        <div>
            <div className='absolute z-20 text-white top-48 left-24 w-1/4'>
                ...
                <div className='my-2 flex'>
                    <button onClick={() => { setTrailerPage(true) }} className='bg-white py-3 px-7 rounded mx-2 text-black font-bold hover:bg-opacity-70 flex items-center gap-1'><i className="fa-solid fa-play text-xl"></i> <span>Trailer</span></button>
